...
const Template=({title,desc1,desc2,formType,setIsLoggedIn})=>{
    return(
        <div className="flex bg-richblack-900 lg:flex-row flex-col lg:w-11/12 w-full lg:max-w-[1160px] mx-auto lg:pt-2 pt-12 items-center justify-between gap-y-11 mb-11 lg:gap-y-0">
            ...
            <div className="w-11/12 max-w-[450px] flex flex-col gap-0  ">
                ...
                <div className="w-full flex justify-center items-center rounded-[8px] font-medium text-richblack-100 border border-richblack-700 px-[12px] py-[8px] gap-x-2  ">
                {<FcGoogle/>}
